...
class Circulo extends Formas
{
    ...
    public function  __construct($id = 0, $raio = 1, $cor = "black", UnidadeMedida $id_un = null, $fundo = "null")
    {
        parent::__construct($id, $cor, $id_un, $fundo);
        $this->setRaio($raio);
    } 
    ...
    public function incluir()
{
    $sql = 'INSERT INTO circulo (raio, cor, id_un, fundo)   
            VALUES (:raio, :cor, :id_un, :fundo)';

    $parametros = array(
        ':raio' => $this->raio, 
        ':cor' => parent::getCor(), 
        ':id_un' => parent::getUn()->getId(),
    ...
    {
        $sql = 'UPDATE circulo
                SET raio = :raio, cor = :cor, id_un = :un, id = :id, fundo = :fundo
                WHERE id_circulo = :id';
    ...
    public static function listar($tipo = 0, $busca = ""):array
    {
        ...
        if ($tipo > 0) {
            switch ($tipo) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    $sql .= " INNER JOIN un ON (unidademedida.id_un = quadrado.id_un) WHERE formas.unidademedida LIKE :busca";
                    $busca = "%{$busca}%";
                    break;
                case 5:
        ...
        while ($forma = $comando->fetch(PDO::FETCH_ASSOC)) {
            $un = UnidadeMedida :: listar(1,$forma['id'])[0]; 
